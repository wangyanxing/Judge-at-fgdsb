...
object subarray_sum2 {
    ...
    def load_test() = {
        val in = Source.fromFile("./judge/tests/subarray-sum2.txt").getLines;
    ...
    def judge(): Int = {
        ...
        while(i < num_test) {
            ...
            if(answer != out(i)) {
                ...
                var outs = common.to_string(subarray_sum2.in_0(i)) + ", " + common.to_string(subarray_sum2.in_1(i));
                print(outs + ";");
