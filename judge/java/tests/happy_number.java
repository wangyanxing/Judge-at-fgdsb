...
public class happy_number {
    public static int num_test = 2725;
    ...
    public static void load_test() {
        File fil = new File("judge/tests/happy-number.txt");
    ...
    public static void judge() {
        ...
        for(int i = 0; i < num_test; ++i) {
            ...
            boolean answer = s.happy(in_0[i]);
            if(answer != out[i]) {
                common.release_stdout();
                System.out.printf("%d / %d;", i+1, num_test);
                String outs = common.to_string(happy_number.in_org_0[i]);
