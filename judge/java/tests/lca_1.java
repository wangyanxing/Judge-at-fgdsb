...
public class lca_1 {
    ...
    public static void load_test() {
        File fil = new File("judge/tests/lca-1.txt");
    ...
    public static void judge() {
        ...
        for(int i = 0; i < num_test; ++i) {
            ...
            if(!common.equals(out[i], answer)) {
                ...
                String outs = common.to_string(lca_1.in_org_0[i]) + ", " + common.to_string(lca_1.in_org_1[i]) + ", " + common.to_string(lca_1.in_org_2[i]);
